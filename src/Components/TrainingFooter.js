  ...
  <div className="uni-footer">
     ...
     <div className="footer-snippet-larger">
      <div className="footer-icons">
        ...
        <p> Address: 5677 S 1475 E, <br></br>Suite 4B, South Ogden, UT 84403</p>
     ...
     <div className="footer-snippet">
      <div className="footer-icons">
        ...
        <Mailto className="footer-email" email="rob.james@previdence.com" subject="Trainings" body="Hello">
          <p className="email-hover-dark" style={{color: 'black', marginRight: "5px"}}>Email Us: <br></br>rob.james@previdence.com</p>
        </Mailto>
        <div className="footer-line"></div>
     </div>
