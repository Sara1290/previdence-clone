  ...
  <div className="uni-footer">
     ...
     <div className="footer-snippet">
      <div className="footer-icons">
        ...
        <Mailto className="footer-email" email="bobbi.mcgraw@previdence.com" subject="Question from the PPN Info Page" body="Hello">
          <p className="email-hover-dark" style={{color: 'black', marginRight: "5px"}}>Email The PPN Team: <br></br>bobbi.mcgraw@previdence.com</p>
        </Mailto>
        <div className="footer-line"></div>
     </div>
